...
<h2>Payments</h2>
<p>Free is currently available without a credit card. When enabled in Billing, Pro and Team subscriptions are processed by Polar. Paid access will only be activated after confirmation from a verified billing provider; creating an account or selecting a paid plan does not itself create a charge or paid entitlement. A one-time 7-day Pro trial may be available from account settings.</p>
<p>The current price and cancellation terms are shown before purchase and governed by the <a href="/refund">refund policy</a>. Downgrades preserve content and viewer rights; lower-plan limits restrict new creator operations rather than deleting existing data.</p>
