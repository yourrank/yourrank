...
<div class="card" data-egroup="share" id="overlayDesignerCard"><h3>Overlay designer</h3><p class="card-sub">Drag the overlay onto a 1920 × 1080 stream canvas, then copy the composed OBS link — the preview is the live overlay itself.</p>
