...
<header class="v3-head ov-head v3-head--row"><div><h1>Home</h1><p class="ov-scope"><strong id="ovSiteName">Checking…</strong><span id="ovOperatorContext" hidden></span></p><p class="v3-head-sub" id="ovHeadSub">Your community at a glance.</p></div><span class="ov-status" id="ovStatus" data-state="checking"><i aria-hidden="true"></i><span id="ovPublishedStatus">Checking…</span></span></header>
...
<select class="v3-select" id="playerSort" aria-label="Sort players"><option value="score">Sort by: Score</option><option value="name">Sort by: Name</option><option value="wagered">Sort by: Legacy amount</option><option value="prize">Sort by: Prize</option></select>
...
<div class="empty upsell-card" id="embedObsLock" hidden>Stream overlays are available on Pro and Team. <a href="/dashboard/settings/billing?from=overlay" id="overlayUpgrade">Upgrade your plan</a> to add this leaderboard to OBS, Streamlabs, or another streaming app.</div>
...
<span class="v3-chip v3-chip--pro preview-sync" id="previewSyncStatus" data-preview-status role="status" aria-live="polite">Up to date</span>
</div>
</div>
...
<div class="preview-frame" id="previewFrame" data-preview-frame><div class="preview-stage" id="previewStage" data-preview-stage><iframe id="designPreview" name="designPreview" src="" loading="eager" title="Live preview" sandbox="allow-scripts allow-same-origin allow-popups-to-escape-sandbox"></iframe></div><div class="preview-error" id="previewError" data-preview-error role="status" aria-live="polite" hidden><p>Preview could not load. <button class="btn btn--sm" id="previewRetry" type="button" data-preview-retry>Retry</button></p></div></div>
...
<div class="v3-analytics-page">
  ...
  <header class="v3-head"><h1>{chromeStateFor("performance", activeHash, { exact: true })?.tabLabel || chromeStateFor("board", activeHash, { exact: true })?.tabLabel || chromeStateFor("performance", "activity").tabLabel}</h1><p class="v3-head-sub">See who is returning, how code drops are being used, how rewards are used, and what needs attention.</p></header>
  ...
  <div class="v3-perf-panel" data-perf-panel="activity" id="perf-activity">
    ...
    <div class="insights-question-list" id="insightsQuestions" aria-busy="true">
      <section aria-labelledby="insightsCommunityTitle"><header><h2 id="insightsCommunityTitle">Is the community returning?</h2><p>Authenticated members of the selected site.</p><p id="insightsCommunityStatus" class="v3-head-sub" role="status" hidden></p></header><dl><div><dt>New members</dt><dd><strong id="insightsNewMembers"><span class="skeleton v3-skel-kpi" aria-hidden="true"></span></strong><span>Joined during this window</span></dd></div><div><dt>Returning members</dt><dd><strong id="insightsReturningMembers"><span class="skeleton v3-skel-kpi" aria-hidden="true"></span></strong><span>Joined earlier and came back in this window</span></dd></div></dl></section>
      <section aria-labelledby="insightsParticipationTitle"><header><h2 id="insightsParticipationTitle">How are code drops being used?</h2><p>Code-drop claims from the selected site in this UTC window.</p><p id="insightsParticipationStatus" class="v3-head-sub" role="status" hidden></p></header><dl><div><dt>Participants</dt><dd><strong id="insightsParticipants"><span class="skeleton v3-skel-kpi" aria-hidden="true"></span></strong><span>Members who claimed a code drop</span></dd></div><div><dt>Repeat participants</dt><dd><strong id="insightsRepeatParticipants"><span class="skeleton v3-skel-kpi" aria-hidden="true"></span></strong><span>Claimed two or more different drops</span></dd></div><div><dt>Active drops</dt><dd><strong id="insightsActiveDrops"><span class="skeleton v3-skel-kpi" aria-hidden="true"></span></strong><span>Drops with at least one claim</span></dd></div></dl></section>
      <section aria-labelledby="insightsRewardsTitle"><header><h2 id="insightsRewardsTitle">How are rewards being used?</h2><p>Claims from the selected site's free-credit shop.</p><p id="insightsRewardsStatus" class="v3-head-sub" role="status" hidden></p></header><dl><div><dt>Claims submitted</dt><dd><strong id="insightsClaimsSubmitted"><span class="skeleton v3-skel-kpi" aria-hidden="true"></span></strong><span>Created during this window</span></dd></div><div><dt>Claims completed</dt><dd><strong id="insightsClaimsCompleted"><span class="skeleton v3-skel-kpi" aria-hidden="true"></span></strong><span>Completed during this window</span></dd></div><div><dt>Most claimed reward</dt><dd><strong id="insightsTopReward"><span class="skeleton v3-skel-line" aria-hidden="true"></span></strong><span id="insightsTopRewardDetail">Non-cancelled claims</span></dd></div></dl></section>
      <section aria-labelledby="insightsOperationsTitle"><header><h2 id="insightsOperationsTitle">What needs attention?</h2><p>Current operational work, independent of the selected date window.</p></header><dl><div><dt>Reviews</dt><dd><strong id="insightsPendingReviews"><span class="skeleton v3-skel-kpi" aria-hidden="true"></span></strong><a href="/dashboard/audience/reviews">Open Reviews</a></dd></div><div><dt>Claims</dt><dd><strong id="insightsPendingClaims"><span class="skeleton v3-skel-kpi" aria-hidden="true"></span></strong><a href="/dashboard/rewards/redemptions">Open Claims</a></dd></div></dl></section>
    </div>
    ...
    <div class="v3-customize">
      <div class="v3-customize-preview">
        <div class="v3-settings-card preview-mount" data-preview-mount="site" data-preview-target="sitePreview" data-preview-edit="0" data-preview-label-syncing="Updating preview…" data-preview-label-synced="Preview matches your changes">
          ...
          <div class="preview-frame" id="sitePreviewFrame" data-preview-frame><div class="preview-stage" id="sitePreviewStage" data-preview-stage><iframe id="sitePreview" name="sitePreview" src="" loading="lazy" title="Public site preview" sandbox="allow-scripts allow-same-origin allow-popups-to-escape-sandbox"></iframe></div><div class="preview-error" id="sitePreviewError" data-preview-error role="status" aria-live="polite" hidden><p>Preview could not load. <button class="btn btn--sm" type="button" data-preview-retry>Try again</button></p></div></div>
        </div>
      </div>
