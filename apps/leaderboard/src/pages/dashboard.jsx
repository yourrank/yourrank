...
<div class="v3-alert v3-alert--warning" id="ovConnectionAlert" role="alert" hidden><span><b>Kick rewards need attention.</b> <span id="ovConnectionAlertDetail">Reconnect Kick to keep active reward grants working.</span></span><a class="btn btn--sm btn--ghost" id="ovConnectionAlertAction" href="/dashboard/site/connections">Reconnect Kick</a></div>
<div class="v3-alert v3-alert--warning" id="ovAutomationAlert" role="alert" hidden><span><b id="ovAutomationAlertTitle">Scheduled Activity needs attention.</b> <span id="ovAutomationAlertDetail">Review its status before choosing a new future time.</span></span><a class="btn btn--sm btn--ghost" id="ovAutomationAlertAction" href="/dashboard/activities">Review schedule</a></div>
