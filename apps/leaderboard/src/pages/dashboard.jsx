...
<div class="v3-analytics-page">
  ...
  <details class="metric-glossary"><summary>How Insights counts activity</summary><dl><div><dt>Site visits</dt><dd>How many times someone opened your public site.</dd></div><div><dt>Link clicks</dt><dd>How many times someone clicked a sponsor or share link.</dd></div><div><dt>Link shares</dt><dd>How many times someone copied your site link to share it.</dd></div><div><dt>Link click rate</dt><dd>Link clicks as a percentage of site visits in the selected period.</dd></div><div><dt>Sources</dt><dd>Websites that sent visitors to your site when their browser reports one.</dd></div></dl></details>
</div>
</section>
  );
}
