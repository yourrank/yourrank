...
<div class="v3-analytics-page">
  ...
  <header class="v3-head"><h1>{chromeStateFor("performance", activeHash, { exact: true })?.tabLabel || chromeStateFor("board", activeHash, { exact: true })?.tabLabel || chromeStateFor("performance", "activity").tabLabel}</h1><p class="v3-head-sub">See who is returning, how members participate, how rewards are used, and what needs attention.</p></header>
  ...
  <div class="v3-perf-panel" data-perf-panel="activity" id="perf-activity">
    ...
    <div class="insights-question-list" id="insightsQuestions" aria-busy="true">
      <section aria-labelledby="insightsCommunityTitle"><header><h2 id="insightsCommunityTitle">Is the community returning?</h2><p>Authenticated members of the selected site.</p></header><dl><div><dt>New members</dt><dd><strong id="insightsNewMembers"><span class="skeleton v3-skel-kpi" aria-hidden="true"></span></strong><span>Joined during this window</span></dd></div><div><dt>Returning members</dt><dd><strong id="insightsReturningMembers"><span class="skeleton v3-skel-kpi" aria-hidden="true"></span></strong><span>Joined earlier and came back in this window</span></dd></div></dl></section>
      <section aria-labelledby="insightsParticipationTitle"><header><h2 id="insightsParticipationTitle">How are members participating?</h2><p>Safe code-drop activity only; wagering and paid-chance systems are excluded.</p></header><dl><div><dt>Participants</dt><dd><strong id="insightsParticipants"><span class="skeleton v3-skel-kpi" aria-hidden="true"></span></strong><span>Members who claimed a code drop</span></dd></div><div><dt>Repeat participants</dt><dd><strong id="insightsRepeatParticipants"><span class="skeleton v3-skel-kpi" aria-hidden="true"></span></strong><span>Claimed two or more different drops</span></dd></div><div><dt>Active drops</dt><dd><strong id="insightsActiveDrops"><span class="skeleton v3-skel-kpi" aria-hidden="true"></span></strong><span>Drops with at least one claim</span></dd></div></dl></section>
      <section aria-labelledby="insightsRewardsTitle"><header><h2 id="insightsRewardsTitle">How are rewards being used?</h2><p>Claims from the selected site's free-credit shop.</p></header><dl><div><dt>Claims submitted</dt><dd><strong id="insightsClaimsSubmitted"><span class="skeleton v3-skel-kpi" aria-hidden="true"></span></strong><span>Created during this window</span></dd></div><div><dt>Claims fulfilled</dt><dd><strong id="insightsClaimsFulfilled"><span class="skeleton v3-skel-kpi" aria-hidden="true"></span></strong><span>Window claims marked fulfilled</span></dd></div><div><dt>Most claimed reward</dt><dd><strong id="insightsTopReward"><span class="skeleton v3-skel-line" aria-hidden="true"></span></strong><span id="insightsTopRewardDetail">Non-cancelled claims</span></dd></div></dl></section>
