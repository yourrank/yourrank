...
<div class="field"><label>Endpoints</label><div class="api-endpoints"><div class="api-endpoint-row"><code class="overlay-url api-endpoint">POST /api/scores</code><span class="hint">Replace player list</span></div><div class="api-endpoint-row"><code class="overlay-url api-endpoint">PATCH /api/scores</code><span class="hint">Update players</span></div></div><p class="hint mt-4">Use the bulk endpoint to replace a leaderboard or the incremental endpoint to update individual players.</p></div>
<div class="field"><label>API signing key</label><div class="api-key-list" id="apiKeyList"></div><div class="d-flex gap-8 items-center flex-wrap mt-8"><button class="btn btn--sm btn--accent" id="apiKeyCreate" type="button" hidden>Create board key</button><a class="btn btn--sm btn--ghost" href="/docs/api" target="_blank" rel="noopener noreferrer" id="apiDocsLink">Documentation →</a></div><p class="hint mt-4" id="apiKeyHint"></p></div>
</div>
...
<div class="v3-settings">
  ...
  <section class="v3-settings-panel" id="settingsPanelTools" role="tabpanel" aria-labelledby="settingsTabTools" data-settings-panel="tools" hidden>
    <div class="v3-settings-card"><div class="v3-settings-card-head"><div><h2>Advanced site tools</h2><p>Connections and stream tools that support this selected site.</p></div></div><div class="v3-settings-row"><div><b>Automatic score updates</b><p id="postbackStatus">Let a sponsor send score updates without manual imports. The private connection belongs to your account.</p></div><a class="v3-set-btn v3-set-btn--outline" href="/dashboard/settings/connections">Manage connection</a></div><div class="v3-settings-row"><div><b>Stream overlay</b><p>Get the browser-source link for OBS, Streamlabs, or another streaming app.</p></div><a class="v3-set-btn v3-set-btn--outline" href="/dashboard/leaderboard/share">Open sharing</a></div></div>
