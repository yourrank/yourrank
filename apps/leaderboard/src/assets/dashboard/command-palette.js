...
const COMMANDS = [
  ...
  { id: "nav-setup", title: "Overview", group: "Navigation", icon: PALETTE_ICONS.details, keywords: "setup site details schedule", action: () => requestDashboardRoute("board", "setup") },
  { id: "nav-players", title: "Standings", group: "Navigation", icon: PALETTE_ICONS.leaderboard, keywords: "players standings scores leaderboard", action: () => requestDashboardRoute("board", "players") },
  { id: "nav-competitions", title: "Competitions", group: "Navigation", icon: PALETTE_ICONS.leaderboard, keywords: "events event leaderboards challenges", action: () => requestDashboardRoute("board", "competitions") },
  ...
  { id: "nav-history", title: "Standings history", group: "Navigation", icon: PALETTE_ICONS.leaderboard, keywords: "history", action: () => requestDashboardRoute("board", "history") },
