...
// a separate safe product boundary. Restricted legacy destinations remain
// routable for owner-only operational containment but are not primary product
// navigation.
...
// Account (the /dashboard/settings root document).
